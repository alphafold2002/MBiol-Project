...
in=/drives/raid/AboobakerLab/kriszta/ACME_vs_live/ACME_RNA-seq/raw_data #specifies location of raw paried-end fastq files 
    out=/drives/raid/AboobakerLab/kriszta/ACME_vs_live/ACME_RNA-seq/bioinformatics/trimmed_data #specifies output location
    adapters=/drives/raid/AboobakerLab/kriszta/ACME_vs_live/ACME_RNA-seq/bioinformatics/adapters.fasta #specifies files containing the adaptor
...
echo "Running on $f"
#echo $id
hisat2 -p 8 -x /drives/raid/AboobakerLab/kriszta/ACME_vs_live/ACME_RNA-seq/bioinformatics/mapped_reads/hisat2_index/dd_Smed_g4_index_new -1 *${f}*_1_out_paired.fq   -2 *${f}*_2_out_paired.fq | samtools view -Sb | samtools sort -o /drives/raid/AboobakerLab/kriszta/ACME_vs_live/remaining_analysis/aligned_data/${f}.bam
done 
...
```{bash}
#single end:
hisat2 -p 8 -x /drives/raid/AboobakerLab/kriszta/ACME_vs_live/ACME_RNA-seq/bioinformatics/mapped_reads/hisat2_index/dd_Smed_g4_index_new -U Reddien_X2_2_out_trimmed.fq | samtools view -Sb | samtools sort -o Reddien_X2_2.bam 
```
...
samtools view -f 4 -F 8 -b /drives/raid/AboobakerLab/kriszta/ACME_vs_live/ACME_RNA-seq/bioinformatics/mapped_reads/W1.bam > W1_1_unmapped.bam #extract mate 1
samtools view -f 4 -f 8 -b /drives/raid/AboobakerLab/kriszta/ACME_vs_live/ACME_RNA-seq/bioinformatics/mapped_reads/W1.bam > W1_2_unmapped.bam  #extract mate 2
...
hisat2 -p 8 -x /drives/raid/AboobakerLab/kriszta/ACME_vs_live/ACME_RNA-seq/bioinformatics/mapped_reads/index_mitochondria/mitochonrial_index -U unmapped_W1.fasta | samtools view -Sb | samtools sort -o unmapped_W1_output.bam 
...
exonCounts_pu <- featureCounts(readLines("/drives/raid/AboobakerLab/kriszta/ACME_vs_live/library_all.txt")[1:10],
                                               annot.ext =  "/drives/raid/AboobakerLab/kriszta/ACME_vs_live/annotations_functional/Smed.transcripts.fasta.transdecoder.genome.gtf",
...
```{r}
#unpaired unstranded
exonCounts_uu <- featureCounts(readLines("/drives/raid/AboobakerLab/kriszta/ACME_vs_live/library_all.txt")[11:20],
                annot.ext = "/drives/raid/AboobakerLab/kriszta/ACME_vs_live/annotations_functional/Smed.transcripts.fasta.transdecoder.genome.gtf",
                isGTFAnnotationFile= TRUE,
                GTF.featureType = "exon",
                GTF.attrType = "gene_id",
...
exonCounts_ur <- featureCounts(readLines("/drives/raid/AboobakerLab/kriszta/ACME_vs_live/library_all.txt")[21:28],
                annot.ext = "/drives/raid/AboobakerLab/kriszta/ACME_vs_live/annotations_functional/Smed.transcripts.fasta.transdecoder.genome.gtf",
                isGTFAnnotationFile= TRUE,
                GTF.featureType = "exon",
                GTF.attrType = "gene_id",
...
write.csv(merged_counts_tosave, file="/drives/raid/AboobakerLab/kriszta/ACME_vs_live/counts_tpm_matrices/counts_all_datasets.csv", row.names=TRUE)
...
write.csv(matrix_all_datasets, file="/drives/raid/AboobakerLab/kriszta/ACME_vs_live/annotations_functional/matrix_all_datasets.csv", row.names=TRUE)
```
...
write.csv(DE_matrix_all, file="/drives/raid/AboobakerLab/kriszta/ACME_vs_live/counts_tpm_matrices/tpm_all_datasets", row.names=TRUE )

DE_matrix_read<- read.csv ("/drives/raid/AboobakerLab/kriszta/ACME_vs_live/counts_tpm_matrices/tpm_all_datasets")
...
write.csv(DE_matrix, file="/drives/raid/AboobakerLab/kriszta/ACME_vs_live/counts_tpm_matrices/tpm_all.csv", row.names=TRUE )
